...
pub(crate) struct Map {
    ...
    pub(crate) revealed_tiles: Vec<bool>,
    pub(crate) visible_tiles: Vec<bool>,
}

impl Map {
    //根据坐标获取 地图数组中的索引位置
    pub(crate) fn xy_idx(&self, x: i32, y: i32) -> usize {
    ...
    //创建一些 地图和走廊
    pub(crate) fn new_map_rooms_and_corridors() -> Map {
        let mut map = Map{
